    ...
    public ParkingDto getParking(Double latitude, Double longitude) {
        ...
        parkingList.sort(new Comparator<Parking>() {
            ...
            public int compare(Parking p1, Parking p2) {
                double distance1 = haversine(latitude, longitude, p1.getLatitude(), p1.getLongitude());
                double distance2 = haversine(latitude, longitude, p2.getLatitude(), p2.getLongitude());
